...
auto run_naive(std::size_t n, std::size_t max) {
...
auto run_vec_alloc(std::size_t n, std::size_t max) {
    auto t1 = std::chrono::steady_clock::now();
...
auto run_vec_prealloc(std::size_t n, std::size_t max) {
    std::vector <uint_fast32_t> v;
    v.reserve(n);
...
auto run_unnu(std::size_t n, std::size_t max) {
    auto t1 = std::chrono::steady_clock::now();
...
auto run_unnuOLD(std::size_t n, std::size_t max) {
    auto t1 = std::chrono::steady_clock::now();
